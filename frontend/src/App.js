    ...
    <div className="body">
      ...
      <div className="animation-container">
        <div className="animation-container-text">
          <h1>
            <b>
              Enhance Your
              <br /> Analytics with AI
            </b>
          </h1>
          <p>
            Solve problems at the new speed of business with a trusted analytics
            platform.
          </p>
          <div className="animation-container-button">
            <button className="button learn-more" onClick={submitLogout}>
              Log out
            </button>
            <button className="button watch-now" onClick={linkedin}>
              Watch Now
            </button>
          </div>
        </div>
      ...
      <div className="slide_container">
        ...
        >
          ...
          <div className="slide-two">
            ...
            <p>
              Read about new updates and enhancements coming to the AI platform
      ...
      <div className="media_container">
        ...
        <div className="media_container_text">
          <h1>
            See the Alteryx AI Platform <br />
            in Action
          </h1>
          <p>
            See how Alteryx uses AI for smarter, data-driven decision making.
          </p>
          <div className="media_container_text_button">
            <Link to="/test" className="button learn-more">
              Learn More
            </Link>
            <button className="button start_free_trail">
              Start Free Trail
            </button>
          </div>
        </div>
      ...
      <div className="media_container">
        <div className="media_container_text">
          ...
          <p>
            See how McLaren Racing uses Alteryx to gain an edge on the track.
          </p>
          <button className="button learn-more">Learn More</button>
        </div>
      ...
      <div className="after_pic_container">
        <div className="after_pic_container_text">
          ...
          <button onClick={() => toggleDialog(1)}>
            <h2>Button one</h2>
          </button>
          {openDialogIndex === 1 && (
            <div className="dialog-box">
              Dialog for Button oneTo generate random text in JavaScript, you
              can use various approaches depending on the type of text you want
              to generate. Here are a few common methods:
              <button>Learn More 1</button>
            </div>
          )}

          <button onClick={() => toggleDialog(2)}>
            <h2>Button two</h2>
          </button>
          {openDialogIndex === 2 && (
            <div className="dialog-box">
              Dialog for ButtoTo generate random text in JavaScript, you can use
              various approaches depending on the type of text you want to
              generate. Here are a few common methods:n two
              <button>Learn more 2</button>
            </div>
          )}

          <button onClick={() => toggleDialog(3)}>
            <h2>Button three</h2>
          </button>
          {openDialogIndex === 3 && (
            <div className="dialog-box">
              Dialog To generate random text in JavaScript, you can use va rious
              approaches depending on the type of text you want to generate.
              Here are a few common methods:for Button three
              <button>learn more 3</button>
            </div>
          )}

          <button onClick={() => toggleDialog(4)}>
            <h2>Button four</h2>
          </button>
          {openDialogIndex === 4 && (
            <div className="dialog-box">
              Dialog foTo generate random text in JavaScript, you can use
              various approaches depending on the type of text you want to
              generate. Here are a few common methods:r Button four
              <button>Learn more 4</button>
            </div>
          )}

          <button onClick={() => toggleDialog(5)}>
            <h2>Button five</h2>
          </button>
          {openDialogIndex === 5 && (
            <div className="dialog-box">
              Dialog for ButTo generate random text in JavaScript, you can use
              various approaches depending on the type of text you want to
              generate. Here are a few common methods:ton five
              <button>learn more 5</button>
            </div>
          )}
        </div>
      ...
      <div className="after_states_container">
        ...
        <p>
          Alteryx Maveryx share how our platform is driving game-changing,
          cost-saving and value driven results.
        </p>
        <video controls>
